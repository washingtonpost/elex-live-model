...
class CombinedDataHandler:
    ...
    def _get_non_modeled_units(
        ...
        # these are all already reporting and expected units
        tf_by_state = (
            reporting_units[~reporting_units["geographic_unit_fips"].isin(zero_baseline_units)]
            .groupby(["postal_code"])
        ...
        units_with_strange_turnout_factor = reporting_units.merge(tf_by_state, on="postal_code", how="left")
